...
public class PostRepositoryImpl implements PostRepositoryCustom {
	...
	@Override
	public List<MainBoardPostDto> findMainBoardPostDtoByArticle(Long memberId, String article, Long offset, Long limit,
		String sort) {
		return queryFactory
			.select(Projections.constructor(MainBoardPostDto.class,
				...
				QFollowEntity.followEntity.isNotNull(),
			...
			.leftJoin(QFollowEntity.followEntity)
			.on(QFollowEntity.followEntity.followerId.eq(memberId)
				.and(QFollowEntity.followEntity.followeeId.eq(QPostEntity.postEntity.member.id))
			)
	...
	@Override
	public List<MainBoardPostDto> findMainBoardPostDtoByStockId(Long memberId, Long stockId, Long offset, Long limit,
		String sort) {
		return queryFactory
			.select(Projections.constructor(MainBoardPostDto.class,
				QPostEntity.postEntity.id,
